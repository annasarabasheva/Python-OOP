from mmovie_app.movie_app import MovieApp
from mmovie_app.movie_specification.fantasy import Fantasy
from mmovie_app.movie_specification.action import Action

movie_app = MovieApp()
print(movie_app.register_user('Martin', 24))
user = movie_app.users_collection[0]
movie = Action('Die Hard', 1988, user, 18)
sameMovie = Action('Die Hard', 1988, user, 18)


print(movie_app.upload_movie('Martin', movie))
print(movie_app.upload_movie('Martin', sameMovie))
print(movie_app.delete_movie('Martin', sameMovie))
print(movie_app.users_collection[0])
# print(movie_app.movies_collection[0].title)
# print(movie_app.register_user('Alexandra', 25))
# print(movie_app.register_user('Alexandra1', 25))
